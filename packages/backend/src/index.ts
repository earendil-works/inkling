...
const publicStyles = `:root{color-scheme:light dark;font-family:ui-serif,Georgia,serif;line-height:1.65}body{margin:0}header{display:flex;justify-content:space-between;padding:1rem 3vw;border-bottom:1px solid #888;font:700 .75rem ui-monospace,monospace;letter-spacing:.08em}main{display:grid;grid-template-columns:minmax(12rem,18rem) minmax(0,48rem);gap:clamp(2rem,6vw,7rem);max-width:78rem;margin:0 auto;padding:clamp(3rem,8vw,8rem) 3vw}aside{font: .8rem ui-monospace,monospace}aside ol{padding-left:1.2rem}.depth-3{margin-left:1rem}article{min-width:0}article h1{font-size:clamp(2.8rem,7vw,5.5rem);line-height:.95}pre{overflow:auto;padding:1rem}table{border-collapse:collapse}td,th{border:1px solid #888;padding:.4rem .7rem}img{max-width:100%}@media(max-width:50rem){main{grid-template-columns:1fr}aside{display:none}}`;

const publicCodeStyles = `:root{--code-background:#f1f4f0;--code-text:#27312c;--code-comment:#707a73;--code-keyword:#a13f59;--code-title:#6957a5;--code-attribute:#176d8a;--code-string:#277044;--code-symbol:#a35827;--code-addition:#dff3e5;--code-deletion:#f8dedb}pre.jot-code{border:1px solid #dfe2df;border-radius:3px;background:var(--code-background);color:var(--code-text);font:.8rem/1.55 ui-monospace,monospace}.hljs-doctag,.hljs-keyword,.hljs-meta .hljs-keyword,.hljs-template-tag,.hljs-template-variable,.hljs-type,.hljs-variable.language_{color:var(--code-keyword)}.hljs-title,.hljs-title.class_,.hljs-title.class_.inherited__,.hljs-title.function{color:var(--code-title)}.hljs-attr,.hljs-attribute,.hljs-literal,.hljs-meta,.hljs-number,.hljs-operator,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-id,.hljs-variable{color:var(--code-attribute)}.hljs-meta .hljs-string,.hljs-regexp,.hljs-string,.hljs-name,.hljs-selector-pseudo,.hljs-selector-tag{color:var(--code-string)}.hljs-built_in,.hljs-bullet,.hljs-symbol{color:var(--code-symbol)}.hljs-code,.hljs-comment,.hljs-formula,.hljs-quote{color:var(--code-comment)}.hljs-section{color:var(--code-attribute);font-weight:700}.hljs-emphasis{font-style:italic}.hljs-strong{font-weight:700}.hljs-addition{background:var(--code-addition);color:var(--code-string)}.hljs-deletion{background:var(--code-deletion);color:var(--code-keyword)}@media(prefers-color-scheme:dark){:root{--code-background:#171a18;--code-text:#e5ebe6;--code-comment:#89938c;--code-keyword:#ff8c9f;--code-title:#c5b6ff;--code-attribute:#87cef1;--code-string:#9bd6ae;--code-symbol:#efad72;--code-addition:#193c27;--code-deletion:#4c2422}pre.jot-code{border-color:#343a36}}`;
